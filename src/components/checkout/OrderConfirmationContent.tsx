  ...
  if (order === null) {
    return (
      <Container className="flex flex-col items-center gap-5 py-24 text-center sm:py-32">
        ...
        <div>
          <h1 className="font-serif text-4xl leading-tight tracking-tight sm:text-5xl">No demo order found.</h1>
    ...
    <Container className="py-12 sm:py-16 lg:py-20">
      ...
      <div className="mt-10 grid grid-cols-1 gap-10 lg:grid-cols-12 lg:gap-12">
        <div className="lg:col-span-7">
          <h2 className="font-serif text-2xl text-cacao">Order Details</h2>
